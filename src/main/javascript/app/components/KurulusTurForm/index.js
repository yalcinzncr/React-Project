...
export class KurulusTurForm extends React.Component {
  state = {
    form: {
      id : null,
      ad: null,
      ...
      <Form>
        <Form.Group>
          <Form.Field width="16" error={validation.ad.touched && !validation.ad.isValid}>
            <Form.Input
              label="Kuruluş Tür Adı"
              placeholder="Kuruluş tür ad giriniz"
              name="ad"
              value={_.get(form, 'ad') || ''}
...
KurulusTurForm.propTypes = {
  data: PropTypes.object,
  onChange: PropTypes.func,
  resources: PropTypes.object,
};

export default KurulusTurForm;
