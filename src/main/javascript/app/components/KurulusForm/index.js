...
export class KurulusForm extends React.Component {
  state = {
    form: {
      id: null,
      ad: null,
        ...
        names.forEach(name => {
          ...
          if (name === 'tur.id') {
            if (form.mudurluk === null) {
              _.set(redraft.validation, name, nonValidState('Lütfen kuruluş tür bilgisi giriniz.'));
            } else {
              _.set(redraft.validation, name, validState());
            }
          }
  ...
  render() {
    ...
    const { kurulusTurler } = this.props.resources;
...
KurulusForm.propTypes = {
  data: PropTypes.object,
  onChange: PropTypes.func,
  resources: PropTypes.object,
};

KurulusForm.defaultProps = {
  resources: {
    kurulusTurler: [],
  },
};

export default KurulusForm;
