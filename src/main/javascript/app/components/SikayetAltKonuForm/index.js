...
export class SikayetAltKonuForm extends React.Component {
  state = {
    form: {
      id: null,
      ad: null,
    ...
    this.setState(
      produce(draft => {
        ...
        names.forEach(name => {
          ...
          if (name === 'konu.id') {
            if (form.konu === null) {
              _.set(redraft.validation, name, nonValidState('Lütfen şikayet konu bilgisi giriniz.'));
            } else {
              _.set(redraft.validation, name, validState());
            }
          }
      ...
      <Form>
        ...
        <Form.Group widths="equal">
          <Form.Field>
            <Form.Dropdown
              label="Şikayet Konu"
              placeholder="Şikayet Konu giriniz"
              name="konu.id"
...
SikayetAltKonuForm.propTypes = {
  data: PropTypes.object,
  onChange: PropTypes.func,
  resources: PropTypes.object,
};

SikayetAltKonuForm.defaultProps = {
  resources: {
    konular: [],
  },
};

export default SikayetAltKonuForm;
