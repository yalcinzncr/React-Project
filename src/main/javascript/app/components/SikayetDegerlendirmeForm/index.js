...
export class SikayetDegerlendirmeForm extends React.Component {
  state = {
    form: {
      id : null,
      ad: null,
      ...
      <Form>
        <Form.Group>
          <Form.Field width="16" error={validation.ad.touched && !validation.ad.isValid}>
            <Form.Input
              label="Şikayet Değerlendirme Adı"
              placeholder="Şikayet Değerlendirme Ad giriniz"
              name="ad"
              value={_.get(form, 'ad') || ''}
...
SikayetDegerlendirmeForm.propTypes = {
  data: PropTypes.object,
  onChange: PropTypes.func,
  resources: PropTypes.object,
};

export default SikayetDegerlendirmeForm;
